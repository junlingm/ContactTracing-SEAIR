...
prior <- function(parameters) {
  ...
  tauI_prior = dnorm(parameters[[6]], mean=0.15, sd=0.1, log = T)
...
parameters_initial <- c(betaI1 =  0.6036950,betaI2 = 0.3255494, betaI3 = 0.4452518,  theta= 2.2819232, p= 0.1924505, tauI=0.1610236,I0=2.9015087)
