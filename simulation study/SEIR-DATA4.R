...
seir_model <- function(params, times,fixed) {
  ...
  seir_equations <- function(time, variables, parameters) {
    with(as.list(c(variables, parameters)), {
      ...
      return(list(c(dS, dE,dI,dEI,dET,dII,dIT,dTI,dQ,dT,dX,dR,dnew,dcon,dQT,dvol,dsym)))
    })
  }
...
parameters_initial <- c(betaI1 = 0.4729350,betaI2 =  0.2635146, betaI3 = 0.3439327,  theta=1.8214296, p=0.1688085,tau=0.1553022, I0=3.2910579)
